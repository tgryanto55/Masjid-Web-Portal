           ...
           <div className="fixed inset-0 z-10 overflow-y-auto">
             <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                ...
                <div className="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg border border-gray-100">
                    ...
                    {/* Header */}
                    <div className="bg-white px-6 pt-6 pb-4 flex justify-between items-center border-b border-gray-50">
                        <div>
                            <h3 className="text-xl font-bold text-gray-900">Pengaturan Akun</h3>
                            <p className="text-sm text-gray-500 mt-0.5">Update profil administrator.</p>
                        </div>
                    ...
                    <div className="bg-gray-50 px-6 py-4 flex flex-row-reverse gap-3 border-t border-gray-100">
                        <Button 
                            ...
                            className="w-full sm:w-auto flex justify-center items-center gap-2 shadow-sm"
                        >
                            {status === 'loading' ? (
                                <>
                        ...
                        <button
                            type="button"
                            onClick={onClose}
                            className="mt-0 w-full inline-flex justify-center rounded-lg border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 sm:w-auto sm:text-sm"
                        >
                            Batal
                        </button>
                    </div>
